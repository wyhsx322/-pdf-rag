...
用法::
    ...
    python -m evaluations.eval_prompts
    python -m evaluations.eval_prompts --versions v1
    python -m evaluations.eval_prompts --versions v1 v2
...
def evaluate_version(version: str, use_few_shot: bool = False) -> dict[str, Any]:
    ...
    if use_few_shot:
        ...
        mod = import_module(f"server.rag.prompts.{version}.query_understanding")
