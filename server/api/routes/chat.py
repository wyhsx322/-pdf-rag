...
from server.rag.prompts.v1.answer_generation import get_system as _get_answer_system
...
def _build_chat_context(kb_id: int, question: str, top_k: int, use_reranker: bool, use_rewrite: bool) -> tuple[list[dict], list[str], list[dict], str, str]:
    ...
    from server.rag.retrieval.query import QueryProcessor, INTENT_MAX_CHUNKS, INTENT_MODE
...
async def chat(req: ChatRequest):
    ...
    async def generate():
        ...
        from server.core.config import RAG_LLM_API_KEY_ENV, RAG_LLM_BASE_URL, RAG_LLM_MODEL, RAG_LLM_TEMPERATURE, RAG_LLM_MAX_TOKENS, RAG_REQUEST_TIMEOUT
