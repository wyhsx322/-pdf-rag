...
用法::
    ...
    python -m server.rag.generation.generator <name> <question>

示例::

    python -m server.rag.generation.generator demo1 "系统式线索和启发式线索的说服效果有什么不同？"
"""
...
from server.rag.prompts.templates import (
    get_system_prompt,
