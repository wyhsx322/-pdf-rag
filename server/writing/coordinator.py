...
from server.core.config import COORDINATOR_LLM_API_KEY_ENV, COORDINATOR_LLM_BASE_URL, COORDINATOR_LLM_MODEL
...
class CoordinatorAgent(AgentBase):
    ...
    def __init__(self, project_id: int, kb_id: int, methodology: str = ""):
        ...
        api_key = os.environ.get(COORDINATOR_LLM_API_KEY_ENV, "")
        self._client = OpenAI(api_key=api_key, base_url=COORDINATOR_LLM_BASE_URL)
