...
from server.core.config import LITERATURE_LLM_API_KEY_ENV, LITERATURE_LLM_BASE_URL, LITERATURE_LLM_MODEL
...
class LiteratureAgent(AgentBase):
    ...
    def __init__(self, project_id: int, session_id: str, kb_id: int):
        ...
        self.kb_id = kb_id
        api_key = os.environ.get(LITERATURE_LLM_API_KEY_ENV, "")
        self._client = OpenAI(api_key=api_key, base_url=LITERATURE_LLM_BASE_URL)
