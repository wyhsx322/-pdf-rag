...
from server.core.config import WRITING_LLM_API_KEY_ENV, WRITING_LLM_BASE_URL, WRITING_LLM_MODEL
...
class SectionWritingAgent(AgentBase):
    ...
    def __init__(
        ...
        api_key = os.environ.get(WRITING_LLM_API_KEY_ENV, "")
        self._client = OpenAI(api_key=api_key, base_url=WRITING_LLM_BASE_URL)
